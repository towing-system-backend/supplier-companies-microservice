...
namespace Application.Core
{
    ...
    public class MongoPerformanceLogsRespository : IPerformanceLogsRepository
    {
        ...
        public MongoPerformanceLogsRespository()
        {
            ...
            var indexKeysDefinition = Builders<MongoPerformanceLogs>.IndexKeys.Ascending(e => e.OperationType);
            var indexModel = new CreateIndexModel<MongoPerformanceLogs>(indexKeysDefinition);
            _performanceLogsCollection.Indexes.CreateOne(indexModel);
        }
